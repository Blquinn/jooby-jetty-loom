...
public class LimitedInputStream extends FilterInputStream {
   ...
   * @param maxSize The limit; no more than this number of bytes shall be returned by the source
   *     stream.
   */
  ...
  /**
   * Reads the next byte of data from this input stream. The value byte is returned as an <code>int
